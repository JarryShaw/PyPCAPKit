...
page = requests.get('https://www.iana.org/assignments/hip-parameters/hip-cipher-id.csv')
...
with open(os.path.join(ROOT, '../_common/hip_cipher_id.py'), 'w') as file:
    file.write('# -*- coding: utf-8 -*-\n\n\n')
    file.write('# Cipher IDs\n')
    file.write('_CIPHER_ID = {\n')
