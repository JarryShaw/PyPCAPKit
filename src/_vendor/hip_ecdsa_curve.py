...
page = requests.get('https://www.iana.org/assignments/hip-parameters/ecdsa-curve-label.csv')
...
with open(os.path.join(ROOT, '../_common/hip_ecdsa_curve.py'), 'w') as file:
    file.write('# -*- coding: utf-8 -*-\n\n\n')
    file.write('# ECDSA Curve Label\n')
    file.write('_ECDSA_CURVE = {\n')
