...
page = requests.get('https://www.iana.org/assignments/hip-parameters/nat-traversal.csv')
...
with open(os.path.join(ROOT, '../_common/hip_mode_id.py'), 'w') as file:
    file.write('# -*- coding: utf-8 -*-\n\n\n')
    file.write('# HIP NAT Traversal Modes\n')
    file.write('_MODE_ID = {\n')
