...
page = requests.get('https://www.iana.org/assignments/ospf-authentication-codes/authentication-codes.csv')
...
with open(os.path.join(ROOT, '../_common/ospf_auth.py'), 'w') as file:
    file.write('# -*- coding: utf-8 -*-\n\n\n')
    file.write('# Authentication Types\n')
    file.write('AUTH = {\n')
