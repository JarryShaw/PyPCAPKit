...
page = requests.get('https://www.iana.org/assignments/hip-parameters/ecdsa-low-curve-label.csv')
...
with open(os.path.join(ROOT, '../_common/hip_ecdsa_low_curve.py'), 'w') as file:
    file.write('# -*- coding: utf-8 -*-\n\n\n')
    file.write('# ECDSA_LOW Curve Label\n')
    file.write('_ECDSA_LOW_CURVE = {\n')
