...
page = requests.get('https://www.iana.org/assignments/ip-parameters/ipv4-router-alert-option-values.csv')
...
with open(os.path.join(ROOT, '../_common/ipv4_router_alert.py'), 'w') as file:
    file.write('# -*- coding: utf-8 -*-\n\n\n')
    file.write('# IPv4 Router Alert Option Values\n')
