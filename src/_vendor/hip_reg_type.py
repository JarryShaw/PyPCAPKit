...
page = requests.get('https://www.iana.org/assignments/hip-parameters/hip-parameters-11.csv')
...
with open(os.path.join(ROOT, '../_common/hip_reg_type.py'), 'w') as file:
    file.write('# -*- coding: utf-8 -*-\n\n\n')
    file.write('# Registration Types\n')
    file.write('_REG_TYPE = {\n')
