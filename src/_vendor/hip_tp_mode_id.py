...
page = requests.get('https://www.iana.org/assignments/hip-parameters/transport-modes.csv')
...
with open(os.path.join(ROOT, '../_common/hip_tp_mode_id.py'), 'w') as file:
    file.write('# -*- coding: utf-8 -*-\n\n\n')
    file.write('# HIP Transport Modes\n')
    file.write('_TP_MODE_ID = {\n')
