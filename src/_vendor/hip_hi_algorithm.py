...
page = requests.get('https://www.iana.org/assignments/hip-parameters/hi-algorithm.csv')
...
with open(os.path.join(ROOT, '../_common/hip_hi_algorithm.py'), 'w') as file:
    file.write('# -*- coding: utf-8 -*-\n\n\n')
    file.write('# HI Algorithm\n')
    file.write('_HI_ALGORITHM = {\n')
