...
page = requests.get('https://www.iana.org/assignments/hip-parameters/esp-transform-suite-ids.csv')
...
with open(os.path.join(ROOT, '../_common/hip_esp_suite_id.py'), 'w') as file:
    file.write('# -*- coding: utf-8 -*-\n\n\n')
    file.write('# ESP Transform Suite IDs\n')
    file.write('_ESP_SUITE_ID = {\n')
