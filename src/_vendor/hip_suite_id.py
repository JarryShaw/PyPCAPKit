...
page = requests.get('https://www.iana.org/assignments/hip-parameters/hip-parameters-6.csv')
...
with open(os.path.join(ROOT, '../_common/hip_suite_id.py'), 'w') as file:
    file.write('# -*- coding: utf-8 -*-\n\n\n')
    file.write('# Suite IDs\n')
    file.write('_SUITE_ID = {\n')
