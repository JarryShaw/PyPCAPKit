...
page = requests.get('https://www.iana.org/assignments/ipv6-parameters/taggerId-types.csv')
...
with open(os.path.join(ROOT, '../_common/ipv6_tid_type.py'), 'w') as file:
    file.write('# -*- coding: utf-8 -*-\n\n\n')
    file.write('# TaggerId Types\n')
    file.write('_TID_TYPE = {\n')
