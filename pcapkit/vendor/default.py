...
class {}(IntEnum):
    ...
    def _missing_(cls, value):
        ...
        {}
        {}
'''.format(DOCS, NAME, NAME, NAME, NAME, DOCS, ENUM, NAME, NAME, NAME, NAME, FLAG, MISS, '' if '        return cls(value)' in MISS.splitlines()[-1:] else 'return super()._missing_(value)').strip()
        ...
        try:
            ...
            try:
                ...
                with tempfile.TemporaryDirectory(suffix='-tempdir',
                    ...
                    print('Please save the page source at {}'.format(temp_file))
