...
class TCP(AppType):
    ...
    not just ``tcp``, so a service registered on several transports appears in
    ...
    #: - [TCP] 3COM-TSMUX
    #: - [UDP] 3COM-TSMUX
    TCP_3com_tsmux = 106, '3com-tsmux', TransportProtocol.tcp | TransportProtocol.udp
    ...
    TCP_914c_g = 211, '914c-g', TransportProtocol.tcp | TransportProtocol.udp
    ...
    TCP_9pfs = 564, '9pfs', TransportProtocol.tcp | TransportProtocol.udp
    ...
    #: - [TCP] 3Com AMP3
    #: - [UDP] 3Com AMP3
    TCP_3com_amp3 = 629, '3com-amp3', TransportProtocol.tcp | TransportProtocol.udp
    ...
    TCP_3comnetman = 1181, '3comnetman', TransportProtocol.tcp | TransportProtocol.udp
    ...
    #: - [TCP] 3l-l1
    #: - [UDP] 3l-l1
    TCP_3l_l1 = 1511, '3l-l1', TransportProtocol.tcp | TransportProtocol.udp
    ...
    #: - [TCP] 3ds-lm
    #: - [UDP] 3ds-lm
    TCP_3ds_lm = 1538, '3ds-lm', TransportProtocol.tcp | TransportProtocol.udp
    ...
    TCP_3m_image_lm = 1550, '3m-image-lm', TransportProtocol.tcp | TransportProtocol.udp
    ...
    #: - [TCP] 3Com-nsd
    #: - [UDP] 3Com-nsd
    TCP_3com_nsd = 1742, '3com-nsd', TransportProtocol.tcp | TransportProtocol.udp
    ...
    #: - [TCP] 3d-nfsd
    #: - [UDP] 3d-nfsd
    TCP_3d_nfsd = 2323, '3d-nfsd', TransportProtocol.tcp | TransportProtocol.udp
    ...
    #: - [TCP] 3Com WebView
    #: - [UDP] 3Com WebView
    TCP_3com_webview = 2339, '3com-webview', TransportProtocol.tcp | TransportProtocol.udp
    ...
    #: - [TCP] 3COM Net Management
    #: - [UDP] 3COM Net Management
    TCP_3com_net_mgmt = 2391, '3com-net-mgmt', TransportProtocol.tcp | TransportProtocol.udp
    ...
    #: - [TCP] 4-TIER OPM GW
    #: - [UDP] 4-TIER OPM GW
    TCP_4_tieropmgw = 2933, '4-tieropmgw', TransportProtocol.tcp | TransportProtocol.udp

    #: - [TCP] 4-TIER OPM CLI
    #: - [UDP] 4-TIER OPM CLI
    TCP_4_tieropmcli = 2934, '4-tieropmcli', TransportProtocol.tcp | TransportProtocol.udp
    ...
    TCP_1ci_smcs = 3091, '1ci-smcs', TransportProtocol.tcp | TransportProtocol.udp
    ...
    #: - [TCP] 4Talk
    #: - [UDP] 4Talk
    TCP_4talk = 3284, '4talk', TransportProtocol.tcp | TransportProtocol.udp
    ...
    TCP_3comfaxrpc = 3446, '3comfaxrpc', TransportProtocol.tcp | TransportProtocol.udp
    ...
    TCP_802_11_iapp = 3517, '802-11-iapp', TransportProtocol.tcp | TransportProtocol.udp
    ...
    TCP_3com_njack_1 = 5264, '3com-njack-1', TransportProtocol.tcp | TransportProtocol.udp

    #: - [TCP] 3Com Network Jack Port 2
    #: - [UDP] 3Com Network Jack Port 2
    TCP_3com_njack_2 = 5265, '3com-njack-2', TransportProtocol.tcp | TransportProtocol.udp
    ...
    TCP_3par_evts = 5781, '3par-evts', TransportProtocol.tcp | TransportProtocol.udp

    #: - [TCP] 3PAR Management Service
    #: - [UDP] 3PAR Management Service
    TCP_3par_mgmt = 5782, '3par-mgmt', TransportProtocol.tcp | TransportProtocol.udp

    #: - [TCP] 3PAR Management Service with SSL
    #: - [UDP] 3PAR Management Service with SSL
    TCP_3par_mgmt_ssl = 5783, '3par-mgmt-ssl', TransportProtocol.tcp | TransportProtocol.udp
    ...
    TCP_3par_rcopy = 5785, '3par-rcopy', TransportProtocol.tcp | TransportProtocol.udp
    ...
    TCP_3link = 15363, '3link', TransportProtocol.tcp | TransportProtocol.udp
