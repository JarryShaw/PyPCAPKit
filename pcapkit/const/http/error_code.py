...
which is automatically generated from :class:`pcapkit.const.http.error_code.ErrorCode`.
...
class ErrorCode(IntEnum):
    ...
    #: CONNECT_ERROR, TCP connection error for CONNECT method [:rfc:`9113, Section
    #: 7`]
    ...
    #: INADEQUATE_SECURITY, Negotiated TLS parameters not acceptable [:rfc:`9113,
    #: Section 7`]
